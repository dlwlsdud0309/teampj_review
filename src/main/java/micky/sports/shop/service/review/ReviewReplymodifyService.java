...
public class ReviewReplymodifyService implements MickyServiceInter{
	private SqlSession sqlSession;

	public ReviewReplymodifyService(SqlSession sqlSession) {
		this.sqlSession=sqlSession;
	}
	
	@Override
	public void execute(Model model) {
		System.out.println(">>>ReviewReplymodifyService");
